...
Raw file contains the dataset, as well as additional sheets with containing all pivot tables and the final dashboard. (To download, click on link, then click on view raw)
...
This dashboard focuses on overall business performance and year-over-year comparison (2023 vs. 2024).  <br />
Key Features: 
...
•	PivotTables
•	PivotCharts
•	KPI calculations and dashboard formatting

## Process Summary
1.	Reviewed the dataset for completeness and consistency
2.	Structured data using PivotTables to support multiple analytical views
3.	Developed KPIs to measure performance and year-over-year change
4.	Designed two dashboards to address different business perspectives
